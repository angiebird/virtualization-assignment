...
class VideoSlice (EventMixin):
    ...
    def portmap (self, dpid_str, srcMac, dstMac, in_port, tcpp):
        out_port = None
        if dpid_str == "00-00-00-00-00-01":
            if dstMac == EthAddr("00:00:00:00:00:01"):
                out_port = 3
            elif dstMac == EthAddr("00:00:00:00:00:02"):
                out_port = 4
            elif in_port == 3 or in_port == 4:
                if tcpp and (tcpp.dstport == 80):
                    out_port = 2
                else:
                    out_port = 1
        elif dpid_str == "00-00-00-00-00-04":
            if dstMac == EthAddr("00:00:00:00:00:03"):
                out_port = 3
            elif dstMac == EthAddr("00:00:00:00:00:04"):
                out_port = 4
            elif in_port == 3 or in_port == 4:
                if tcpp and (tcpp.dstport == 80):
                    out_port = 2
                    ...
                    out_port = 1
        elif dpid_str == "00-00-00-00-00-03":
            if in_port == 2:
                out_port = 1
            elif in_port == 1:
                out_port = 2
        elif dpid_str == "00-00-00-00-00-02":
            if in_port == 2:
                out_port = 1
            elif in_port == 1:
                out_port = 2
